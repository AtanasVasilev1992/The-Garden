...
export function useCreateFruitComment() {
    const createHandler = (fruitId, comment) =>  commentsAPI.createFruitComment(fruitId, comment);

    return createHandler;
};

export function useCreateVegetableComment() {
    const createHandler = (vegetableId, comment) =>  commentsAPI.createVegetableComment(vegetableId, comment);
